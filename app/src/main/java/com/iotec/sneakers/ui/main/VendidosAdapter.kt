...
class VendidosAdapter(var lista:MutableList<Product>,
                      val clickListener:(Product)-> Unit): RecyclerView.Adapter<VendidosAdapter.Contenedor>()
{
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i:Int):Contenedor  {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.ofertas, viewGroup, false);
